...
tailcall.$(OBJEXT): {$(VPATH)}tailcall.c
tailcall.$(OBJEXT): $(CCAN_DIR)/check_type/check_type.h
tailcall.$(OBJEXT): $(CCAN_DIR)/container_of/container_of.h
tailcall.$(OBJEXT): $(CCAN_DIR)/list/list.h
tailcall.$(OBJEXT): $(CCAN_DIR)/str/str.h
tailcall.$(OBJEXT): $(hdrdir)/ruby/ruby.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/array.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/compilers.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/error.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/gc.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/imemo.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/serial.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/string.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/vm.h
tailcall.$(OBJEXT): $(top_srcdir)/internal/warnings.h
tailcall.$(OBJEXT): {$(VPATH)}assert.h
tailcall.$(OBJEXT): {$(VPATH)}atomic.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/assume.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/bool.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/limits.h
tailcall.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
...
tailcall.$(OBJEXT): {$(VPATH)}eval_intern.h
...
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
tailcall.$(OBJEXT): {$(VPATH)}internal/assume.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/const.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/error.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/format.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
tailcall.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
tailcall.$(OBJEXT): {$(VPATH)}internal/cast.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
tailcall.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
tailcall.$(OBJEXT): {$(VPATH)}internal/config.h
tailcall.$(OBJEXT): {$(VPATH)}internal/constant_p.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/robject.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
tailcall.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
tailcall.$(OBJEXT): {$(VPATH)}internal/ctype.h
tailcall.$(OBJEXT): {$(VPATH)}internal/dllexport.h
tailcall.$(OBJEXT): {$(VPATH)}internal/dosish.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/coderange.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/ctype.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/encoding.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/pathname.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/re.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/sprintf.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/string.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/symbol.h
tailcall.$(OBJEXT): {$(VPATH)}internal/encoding/transcode.h
tailcall.$(OBJEXT): {$(VPATH)}internal/error.h
tailcall.$(OBJEXT): {$(VPATH)}internal/eval.h
tailcall.$(OBJEXT): {$(VPATH)}internal/event.h
tailcall.$(OBJEXT): {$(VPATH)}internal/fl_type.h
tailcall.$(OBJEXT): {$(VPATH)}internal/gc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/glob.h
tailcall.$(OBJEXT): {$(VPATH)}internal/globals.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/extension.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/feature.h
tailcall.$(OBJEXT): {$(VPATH)}internal/has/warning.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/array.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/class.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/error.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/file.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/io.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/load.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/object.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/process.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/random.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/range.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/re.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/select.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/string.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/time.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
tailcall.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
tailcall.$(OBJEXT): {$(VPATH)}internal/interpreter.h
tailcall.$(OBJEXT): {$(VPATH)}internal/iterator.h
tailcall.$(OBJEXT): {$(VPATH)}internal/memory.h
tailcall.$(OBJEXT): {$(VPATH)}internal/method.h
tailcall.$(OBJEXT): {$(VPATH)}internal/module.h
tailcall.$(OBJEXT): {$(VPATH)}internal/newobj.h
tailcall.$(OBJEXT): {$(VPATH)}internal/rgengc.h
tailcall.$(OBJEXT): {$(VPATH)}internal/scan_args.h
tailcall.$(OBJEXT): {$(VPATH)}internal/special_consts.h
tailcall.$(OBJEXT): {$(VPATH)}internal/static_assert.h
tailcall.$(OBJEXT): {$(VPATH)}internal/stdalign.h
tailcall.$(OBJEXT): {$(VPATH)}internal/stdbool.h
tailcall.$(OBJEXT): {$(VPATH)}internal/symbol.h
tailcall.$(OBJEXT): {$(VPATH)}internal/value.h
tailcall.$(OBJEXT): {$(VPATH)}internal/value_type.h
tailcall.$(OBJEXT): {$(VPATH)}internal/variable.h
tailcall.$(OBJEXT): {$(VPATH)}internal/warning_push.h
tailcall.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
tailcall.$(OBJEXT): {$(VPATH)}iseq.h
tailcall.$(OBJEXT): {$(VPATH)}method.h
tailcall.$(OBJEXT): {$(VPATH)}missing.h
tailcall.$(OBJEXT): {$(VPATH)}node.h
tailcall.$(OBJEXT): {$(VPATH)}onigmo.h
tailcall.$(OBJEXT): {$(VPATH)}oniguruma.h
tailcall.$(OBJEXT): {$(VPATH)}ruby_assert.h
tailcall.$(OBJEXT): {$(VPATH)}ruby_atomic.h
tailcall.$(OBJEXT): {$(VPATH)}st.h
tailcall.$(OBJEXT): {$(VPATH)}subst.h
tailcall.$(OBJEXT): {$(VPATH)}thread_$(THREAD_MODEL).h
tailcall.$(OBJEXT): {$(VPATH)}thread_native.h
tailcall.$(OBJEXT): {$(VPATH)}vm_core.h
tailcall.$(OBJEXT): {$(VPATH)}vm_opts.h
